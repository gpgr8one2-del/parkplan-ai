  ...
  animal_kingdom: {
    ...
    "Gorilla Falls Exploration Trail": {
      ...
      waitProfile: {
        ...
        usuallyHighAllDay: false,
        strategyNote:
          "Self-paced walking trail near Kilimanjaro Safaris. Do not recommend as a line-based attraction or show a wait-time action card.",
      },
      planningProfile: {
        ...
        strategy:
          "Use only as a nearby low-pressure idea after Safaris when the family still has walking energy. It should not appear as Best Move, Smart Backup, Worth the Walk, Plan Ahead, Wait On This, or a normal In Line card.",
      },
      tags: ["animals", "trail", "walkthrough", "outdoor", "family", "context-only"],
    },
    ...
    "Maharajah Jungle Trek": {
      ...
      waitProfile: {
        ...
        usuallyHighAllDay: false,
        strategyNote:
          "Self-paced walking trail in Asia. Do not recommend as a line-based attraction or show a wait-time action card.",
      },
      planningProfile: {
        category: "context_only",
        paidAccess: "none",
        appStatus: "context_only",
        strategy:
          "Use only as a nearby low-pressure idea when the family is already in Asia and still has walking energy. It should not appear in normal ride recommendation slots.",
      },
      tags: ["animals", "trail", "walkthrough", "outdoor", "family", "context-only"],
    },
