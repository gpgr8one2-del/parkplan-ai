      ...
      try {
        ...
        if (!silent) {
          ...
          if (denied) {
            ...
            guidance =
              "Your location is not available right now. TOHI will keep trying while the app is open, or you can pick the closest area manually.";
          }
        ...
        } else if (canKeepWatching) {
          // A first fix can take longer than getCurrentPosition's foreground
          // timeout on a real phone in a crowded park. A timeout or temporary
          // unavailable result is not a permission denial, so hand acquisition
          // to the continuous watcher instead of ending the location attempt.
          // The watcher uses the same detector and stability gate, and clears
          // this message as soon as a usable fix arrives.
          setLocationAutoEnabled(true);
        }
