...
const FAMILY_VOTE_PROMPTS = [
  ...
  {
    prompt: "Which Magic Kingdom classic gets the family crown today?",
    options: ["Pirates of the Caribbean", "Haunted Mansion", "Jungle Cruise", "it's a small world"],
  },
  {
    prompt: "Which Magic Kingdom snack would win if everyone had to share?",
    options: ["Dole Whip", "Mickey pretzel", "Popcorn bucket refill", "Ice cream bar"],
  },
  {
    prompt: "Which land should the family spend extra time in?",
    options: ["Fantasyland", "Adventureland", "Tomorrowland", "Frontierland"],
  },
  {
    prompt: "Which ride photo would probably be the funniest?",
    options: ["TRON", "Space Mountain", "Tiana's Bayou Adventure", "Buzz Lightyear"],
  },
  {
    prompt: "Who should pick the next Magic Kingdom move?",
    options: ["Youngest person", "Most tired person", "Biggest thrill fan", "Snack captain"],
  },
  {
    prompt: "Which Magic Kingdom moment sounds best right now?",
    options: ["Castle view", "Indoor ride", "Cold drink", "Short wait"],
  },
  {
    prompt: "Which family strategy wins the next hour?",
    options: ["One big must-do", "Two easy rides", "Snack and shade", "Show or parade"],
  },
  {
    prompt: "Which Magic Kingdom mountain wins the family vote?",
    options: ["Space Mountain", "Big Thunder Mountain", "Seven Dwarfs Mine Train", "Tiana's Bayou Adventure"],
  },
  {
    prompt: "Which character group would your family rather run into?",
    options: ["Mickey and friends", "Princesses", "Pirates", "Country Bears"],
  },
  {
    prompt: "Which queue would your family handle best right now?",
    options: ["Cool indoor queue", "Shady outdoor queue", "Moving boat queue", "Short but sunny queue"],
  },
  {
    prompt: "Which Magic Kingdom photo should be the keeper?",
    options: ["Castle family photo", "Silly ride photo", "Snack photo", "Parade selfie"],
  },
  {
    prompt: "Which calm break sounds most useful?",
    options: ["PeopleMover", "Railroad", "Hall of Presidents", "Country Bear show"],
  },
  {
    prompt: "Which nighttime plan gets the vote?",
    options: ["Fireworks spot", "Last thrill ride", "Classic dark ride", "Quiet exit snack"],
  },
  {
    prompt: "Which Magic Kingdom phrase fits the family mood?",
    options: ["Let's ride something", "Find the shade", "Snack first", "One more classic"],
  },
  {
    prompt: "Which family member would make the best Jungle Cruise skipper?",
    options: ["Funniest person", "Dad joke expert", "Loudest person", "Most dramatic person"],
  },
  {
    prompt: "Which Tomorrowland stop wins?",
    options: ["TRON", "Buzz Lightyear", "PeopleMover", "Space Mountain"],
  },
  {
    prompt: "Which Fantasyland stop wins?",
    options: ["Peter Pan", "Pooh", "Dumbo", "Under the Sea"],
  },
  {
    prompt: "Which Adventureland stop wins?",
    options: ["Pirates", "Jungle Cruise", "Tiki Room", "Dole Whip"],
  },
  {
    prompt: "Which family win matters most today?",
    options: ["Finishing a must-do", "Keeping everyone happy", "Finding low waits", "Getting great photos"],
  },
  {
    prompt: "Which Magic Kingdom smell wins?",
    options: ["Popcorn", "Churros", "Water ride mist", "Main Street sweets"],
  },
  {
    prompt: "Which person should be trusted with the map?",
    options: ["Best planner", "Fastest walker", "Most patient person", "Absolutely nobody"],
  },
  {
    prompt: "Which kind of ride should TOHI look for next?",
    options: ["Thrill", "Classic", "Indoor", "Nearby"],
  },
  {
    prompt: "Which would make the best family story later?",
    options: ["Unexpected short wait", "Funny ride photo", "Getting soaked", "A perfect snack break"],
  },
  {
    prompt: "Which Magic Kingdom sound wins?",
    options: ["Fireworks boom", "Train whistle", "Parade drums", "Haunted Mansion organ"],
  },
  {
    prompt: "Which line-time game should come next?",
    options: ["Queue Clues", "Would You Rather", "Quick Trivia", "Family Vote again"],
  },
  {
    prompt: "Which Magic Kingdom souvenir would the family actually use?",
    options: ["Mug", "Hat", "Pin", "T-shirt"],
  },
  {
    prompt: "Which ride should get a family rematch someday?",
    options: ["Buzz Lightyear", "Big Thunder", "Pirates", "Space Mountain"],
  },
  {
    prompt: "Which waiting style fits your group?",
    options: ["Talk and laugh", "Play games", "Snack quietly", "Plan the next move"],
  },
  {
    prompt: "Which Magic Kingdom area feels most like Disney?",
    options: ["Main Street", "Fantasyland", "Adventureland", "Tomorrowland"],
  },
  {
...
const WOULD_YOU_RATHER_PROMPTS = [
  ...
  "Would you rather ride Pirates of the Caribbean with your family acting like pirates the whole time or ride Haunted Mansion with everyone doing their best ghost voice?",
  "Would you rather watch fireworks from Main Street with a perfect castle view or from farther back with room to breathe and snack?",
  "Would you rather get stuck on it's a small world for ten extra minutes or have the PeopleMover stop with a great view of Tomorrowland?",
  "Would you rather eat a Dole Whip before Jungle Cruise or a Mickey pretzel before Big Thunder Mountain?",
  "Would you rather rope drop Seven Dwarfs Mine Train or save your energy and ride it later at night?",
  "Would you rather be the skipper on Jungle Cruise or the ghost host at Haunted Mansion?",
  "Would you rather ride TRON once at night or ride Buzz Lightyear twice with a family rematch?",
  "Would you rather spend an hour in Fantasyland doing gentle rides or an hour in Adventureland chasing snacks and classics?",
  "Would you rather sit front row on Big Thunder Mountain or front row on Space Mountain?",
  "Would you rather have the perfect parade spot or the perfect fireworks spot?",
  "Would you rather meet Mickey in a quiet moment or see your favorite character wave from a parade float?",
  "Would you rather ride Peter Pan's Flight with no wait or Pirates of the Caribbean with the whole boat to your family?",
  "Would you rather take a midday castle photo with crowds or an evening castle photo with glowing lights?",
  "Would you rather spend a rainy hour in indoor rides or a hot hour chasing shaded snacks?",
  "Would you rather ride Tiana's Bayou Adventure and get soaked or ride Haunted Mansion and stay perfectly cool?",
  "Would you rather have a surprise low wait for Space Mountain or a surprise low wait for Jungle Cruise?",
  "Would you rather be chosen to help in a show or quietly enjoy the show from the best seat?",
  "Would you rather eat popcorn during the parade or ice cream while waiting for fireworks?",
  "Would you rather take the monorail to Magic Kingdom or arrive by boat with the castle coming into view?",
  "Would you rather spend extra time in the Emporium or extra time exploring the castle hub?",
  "Would you rather your family all pick the same next ride or each person get one turn choosing?",
  "Would you rather ride every mountain in one day or every classic boat ride in one day?",
  "Would you rather have a perfect low-wait morning or a perfect cool-weather evening?",
  "Would you rather find a hidden quiet corner in Liberty Square or a fun snack stop in Adventureland?",
  "Would you rather take a break on the train or take a break on the PeopleMover?",
  "Would you rather ride Dumbo at sunset or the carousel with the castle lit up?",
  "Would you rather spend your last hour repeating a favorite or trying something you skipped all day?",
  "Would you rather have a family photo with everyone smiling or a silly photo that makes everyone laugh later?",
  "Would you rather catch a short surprise show or find a surprise five-minute wait?",
  "Would you rather let the youngest person pick the next ride or let the most tired person pick the next break?",
  "Would you rather get a front-row parade wave or a surprise character interaction in a quiet walkway?",
  "Would you rather ride Jungle Cruise in the daytime with all the jokes or at night with the glowing river mood?",
  "Would you rather eat lunch in air conditioning or grab snacks and keep moving through the park?",
  "Would you rather spend twenty extra minutes waiting for your top must-do or skip it and keep the day calmer?",
  "Would you rather ride Space Mountain with the bravest person in your group or Buzz Lightyear with the most competitive person?",
  "Would you rather find a perfect shaded bench or a perfect empty walkway for a family photo?",
  "Would you rather ride Haunted Mansion right before sunset or Pirates right after dark?",
  "Would you rather have one magical surprise moment or three small easy wins back to back?",
  "Would you rather do one big thrill next or two gentle classics next?",
  "Would you rather grab a cold drink before the next ride or push through and reward everyone after?",
  "Would you rather have the best castle picture of the trip or the funniest ride photo of the trip?",
  "Would you rather ride Tiana's Bayou Adventure first thing or save it for when everyone is hot?",
  "Would you rather watch a cavalcade up close or hear the fireworks music from a quieter area?",
  "Would you rather have a perfect Lightning Lane time or stumble into a perfect standby wait?",
  "Would you rather do Tomorrowland when everyone has energy or Adventureland when everyone wants shade and snacks?",
  "Would you rather have one person be the family navigator or rotate the decision-maker every hour?",
  "Would you rather ride the carousel with castle views or the train with a breeze?",
  "Would you rather spend extra time noticing little details or keep moving to squeeze in one more ride?",
  "Would you rather end the night with a thrill ride or a calm classic?",
  "Would you rather have a perfectly planned Magic Kingdom day or a messy day with one unforgettable family story?",
  "Would you rather ride Haunted Mansion with the lights on or Space Mountain with the lights on?",
  "Would you rather get stuck on PeopleMover for ten minutes or Carousel of Progress for one full extra scene?",
  "Would you rather watch fireworks from Main Street or from behind the castle?",
  "Would you rather have unlimited Dole Whip or unlimited Mickey pretzels for one Magic Kingdom day?",
  "Would you rather be the Jungle Cruise skipper or the person picked for Monsters Inc. Laugh Floor?",
  "Would you rather ride TRON with your favorite person or Big Thunder with the loudest person in your family?",
  "Would you rather meet every princess in one day or ride every mountain in one day?",
  "Would you rather have perfect castle photos or perfect ride photos?",
  "Would you rather rope drop Fantasyland or close the park in Tomorrowland?",
  "Would you rather spend an hour in Adventureland or an hour in Liberty Square?",
  "Would you rather get soaked on Tiana's Bayou Adventure or walk through a surprise Florida downpour?",
  "Would you rather only use boats or only use the railroad to move around Magic Kingdom?",
  "Would you rather have a private ride on Pirates or a private ride on Haunted Mansion?",
  "Would you rather eat lunch in Cinderella Castle or dinner in Liberty Square?",
  "Would you rather have a parade float wave directly at you or a character point at your shirt?",
  "Would you rather win big on Buzz Lightyear or beat everyone at Queue Clues?",
  "Would you rather ride Seven Dwarfs Mine Train twice or Peter Pan's Flight three times?",
  "Would you rather wait in a shaded outdoor line or a cool indoor line with louder noise?",
  "Would you rather be first on Main Street in the morning or last out after fireworks?",
  "Would you rather hear the train whistle all day or the Haunted Mansion organ all day?",
  "Would you rather have one perfect snack break or one perfect short wait?",
  "Would you rather sit by the hub grass or find a quiet bench in Frontierland?",
  "Would you rather take the wildest teacup spin or the slowest Dumbo flight?",
  "Would you rather have every ride photo be hilarious or every family selfie be perfect?",
  "Would you rather get a surprise Lightning Lane for TRON or Tiana's Bayou Adventure?",
  "Would you rather spend extra time in Main Street shops or Tomorrowland shops?",
  "Would you rather watch the parade from the front row or fireworks from a less crowded spot?",
  "Would you rather ride Pirates with no line or Jungle Cruise with the funniest skipper ever?",
  "Would you rather be turned into a ghost at Haunted Mansion or a toy in Fantasyland?",
  "Would you rather have a magic carpet that flies or a doom buggy that follows you home?",
  "Would you rather have every snack shaped like Mickey or every drink come with a glowing cube?",
  "Would you rather ride Space Mountain five times or never wait more than ten minutes all day?",
  "Would you rather get picked as the rebel spy on Star Tours or be That Guy at Laugh Floor?",
  "Would you rather have the castle change color for your family or hear your name in a parade announcement?",
  "Would you rather only ride classics or only ride thrill rides for the next two hours?",
  "Would you rather take a midday break on Tom Sawyer Island or PeopleMover?",
  "Would you rather find a hidden Mickey on every ride or know every ride's secret detail?",
  "Would you rather be a pirate for a day or a royal guard for a day?",
  "Would you rather have popcorn refills all day or cold drinks all day?",
  "Would you rather ride It's a Small World with your own boat or Pirates with your own boat?",
  "Would you rather get a surprise character cavalcade or a surprise low wait on your must-do?",
  "Would you rather have one kid choose every snack or one adult choose every ride?",
  "Would you rather be in charge of the map or in charge of the snack budget?",
  "Would you rather walk through the castle every time or take the fastest route every time?",
  "Would you rather watch fireworks sitting down far away or standing up close?",
  "Would you rather have a perfectly calm morning or a perfectly fun late night?",
  "Would you rather ride Big Thunder in the rain or Jungle Cruise in the rain?",
  "Would you rather trade your next ride for a perfect parade spot or keep moving?",
  "Would you rather have Magic Kingdom all to yourself for one hour or skip every line for two hours?",
  "Would you rather end the day with one last ride or one last snack?",
];
...
const EPCOT_FAMILY_VOTE_PROMPTS = [
  ...
  {
    prompt: "Which EPCOT ride gets the family vote today?",
    options: ["Guardians", "Soarin'", "Remy", "Frozen"],
  },
  {
    prompt: "Which World Showcase choice wins?",
    options: ["Mexico", "France", "Japan", "Germany"],
  },
  {
    prompt: "Which EPCOT snack plan sounds best?",
    options: ["Sweet treat", "Savory snack", "Festival booth", "Cold drink"],
  },
  {
    prompt: "Which pavilion should get extra exploring time?",
    options: ["The Land", "The Seas", "Imagination", "Spaceship Earth"],
  },
  {
    prompt: "Which EPCOT pace fits the family right now?",
    options: ["Slow lap", "Ride focus", "Snack crawl", "Indoor reset"],
  },
  {
    prompt: "Which family role matters most in EPCOT?",
    options: ["Snack chooser", "Ride scout", "Photo finder", "Map reader"],
  },
  {
    prompt: "Which EPCOT view wins?",
    options: ["Spaceship Earth", "World Showcase Lagoon", "France bridge", "Mexico pyramid"],
  },
  {
    prompt: "Which EPCOT classic deserves more love?",
    options: ["Living with the Land", "Spaceship Earth", "Figment", "The Seas"],
  },
  {
    prompt: "Which country should pick the next snack?",
    options: ["Norway", "France", "Japan", "Mexico"],
  },
  {
    prompt: "Which EPCOT sound wins?",
    options: ["Guardians music", "Festival concert", "Fountain splash", "Fireworks finale"],
  },
  {
    prompt: "Which family EPCOT goal wins?",
    options: ["Try something new", "Ride a headliner", "Find shade", "Take great photos"],
  },
  {
    prompt: "Which ride would everyone repeat first?",
    options: ["Remy", "Frozen", "Soarin'", "Guardians"],
  },
  {
    prompt: "Which EPCOT break spot sounds best?",
    options: ["The Seas aquarium", "The Land seating", "Quiet lagoon bench", "Indoor shop"],
  },
  {
    prompt: "Which festival style wins?",
    options: ["Share everything", "Everyone picks one", "Desserts only", "Most unusual item"],
  },
  {
    prompt: "Which EPCOT photo wins?",
    options: ["Spaceship Earth selfie", "Lagoon family shot", "Pavilion detail", "Snack photo"],
  },
  {
    prompt: "Which family member should choose the next country?",
    options: ["Best snack taste", "Best walker", "Biggest Disney fan", "Most curious person"],
  },
  {
    prompt: "Which EPCOT area should TOHI favor next?",
    options: ["World Nature", "World Discovery", "World Celebration", "World Showcase"],
  },
  {
    prompt: "Which EPCOT weather plan wins?",
    options: ["Indoor rides", "Pavilion shops", "Long meal break", "Ponchos and keep going"],
  },
  {
    prompt: "Which EPCOT character vibe wins?",
    options: ["Princesses", "Mickey and friends", "Figment", "Frozen friends"],
  },
  {
    prompt: "Which EPCOT table debate would be funniest?",
    options: ["Best snack", "Best ride", "Best pavilion", "Best bathroom break"],
  },
  {
    prompt: "Which gentle ride wins?",
    options: ["Living with the Land", "Spaceship Earth", "The Seas with Nemo", "Gran Fiesta Tour"],
  },
  {
    prompt: "Which bigger ride wins?",
    options: ["Guardians", "Test Track", "Soarin'", "Frozen"],
  },
  {
    prompt: "Which EPCOT souvenir would win the vote?",
    options: ["Candy", "Mug", "Pin", "Something from Japan"],
  },
  {
    prompt: "Which family strategy should guide World Showcase?",
    options: ["Clockwise", "Counterclockwise", "Only favorites", "Follow the snacks"],
  },
  {
    prompt: "Which country should get the most photo time?",
    options: ["France", "Japan", "Morocco", "Canada"],
  },
  {
    prompt: "Which EPCOT smell wins?",
    options: ["Bakery", "Popcorn", "Festival booths", "Rain on pavement"],
  },
  {
    prompt: "Which low-stress EPCOT win matters most?",
    options: ["Short walk", "Cold drink", "Indoor seat", "Everyone agreeing"],
  },
  {
    prompt: "Which EPCOT ending sounds best?",
    options: ["Fireworks", "Spaceship Earth", "Last snack", "Skyliner ride"],
  },
  {
    prompt: "Which line-time game should come next?",
    options: ["Queue Clues", "Would You Rather", "Quick Trivia", "Family Vote again"],
...
const EPCOT_WOULD_YOU_RATHER_PROMPTS = [
  ...
  "Would you rather ride Guardians of the Galaxy: Cosmic Rewind with your favorite song or ride Soarin' with your favorite scene?",
  "Would you rather snack around World Showcase or ride around Future World with almost no waits?",
  "Would you rather explore every pavilion slowly or pick three favorites and really enjoy them?",
  "Would you rather ride Remy's Ratatouille Adventure with no wait or Frozen Ever After with no wait?",
  "Would you rather watch EPCOT fireworks from the front of the lagoon or from a quieter spot with more space?",
  "Would you rather eat school bread in Norway or a crepe in France?",
  "Would you rather spend extra time in The Land pavilion or The Seas pavilion?",
  "Would you rather design the fastest car on Test Track or make the silliest Figment-style invention?",
  "Would you rather travel the world by snacks or by rides?",
  "Would you rather take a slow boat ride through Living with the Land or a calm aquarium break at The Seas?",
  "Would you rather meet characters in World Showcase or find the best hidden photo spots?",
  "Would you rather ride Spaceship Earth at the start of the day or as your final ride at night?",
  "Would you rather try one adventurous festival food or three safe snacks everyone likes?",
  "Would you rather cool off in a long indoor show or keep moving with short rides and shade?",
  "Would you rather spend a whole hour in Japan or a whole hour in Mexico?",
  "Would you rather ride Soarin' twice or ride Test Track once and Guardians once?",
  "Would you rather take the Skyliner into EPCOT or walk in through the front under Spaceship Earth?",
  "Would you rather find the best dessert in France or the best savory snack in Germany?",
  "Would you rather let everyone choose one pavilion or let one person plan the whole World Showcase lap?",
  "Would you rather get caught in a light rain near The Land or near World Showcase snacks?",
  "Would you rather have a perfect festival booth crawl or a perfect ride-stacking afternoon?",
  "Would you rather watch the jumping fountains or spend time in the aquarium?",
  "Would you rather have a quiet bench with a lagoon view or a shaded indoor table with cold drinks?",
  "Would you rather ride Frozen with the whole family singing or Remy with everyone pretending to be tiny?",
  "Would you rather take a full lap around World Showcase or cut across for the next best ride?",
  "Would you rather try a snack from a country you've never picked before or repeat your favorite EPCOT treat?",
  "Would you rather be in charge of choosing the next pavilion or choosing the next snack?",
  "Would you rather ride Figment and laugh at the chaos or ride Spaceship Earth and relax in the dark?",
  "Would you rather spend extra time before fireworks or leave early before the big crowd rush?",
  "Would you rather have a low-wait ride pop up nearby or a perfect table open up for a snack?",
  "Would you rather spend the afternoon doing rides in air conditioning or take your time browsing World Showcase shops?",
  "Would you rather pick snacks by smell or pick snacks by what looks best in the display case?",
  "Would you rather ride Guardians once with everyone hyped or ride three calmer EPCOT classics in a row?",
  "Would you rather be the family festival food judge or the family ride wait-time scout?",
  "Would you rather explore Morocco's quiet corners or Germany's shops and snacks?",
  "Would you rather have a perfect photo under Spaceship Earth or a perfect family selfie by the lagoon?",
  "Would you rather do Remy first and then France snacks or France snacks first and then Remy?",
  "Would you rather let every family member choose one country or choose countries based only on food?",
  "Would you rather have a surprise character meet in World Showcase or a surprise short wait for a headliner?",
  "Would you rather ride Living with the Land during a storm or watch rain from inside The Seas?",
  "Would you rather spend your final EPCOT hour eating, riding, or watching the park glow?",
  "Would you rather have a slow World Showcase evening or a busy ride-heavy evening?",
  "Would you rather try Beverly once for the story or avoid it forever and protect your taste buds?",
  "Would you rather get the best festival dish of the day or the best festival dessert of the day?",
  "Would you rather have one perfect table-service meal or a bunch of quick bites from different places?",
  "Would you rather ride Test Track in the afternoon sun or after dark with the track lit up?",
  "Would you rather use EPCOT as a calm reset park or a full adventure park?",
  "Would you rather spend more time in pavilions you've never explored or revisit the ones your family already loves?",
  "Would you rather be tiny in Remy's kitchen or fly over the world in Soarin'?",
  "Would you rather end EPCOT with fireworks or one last peaceful ride on Spaceship Earth?",
  ...
  "Would you rather meet Figment or have Remy cook your lunch?",
  "Would you rather ride Frozen with no wait or Remy with no wait?",
  "Would you rather walk World Showcase clockwise or counterclockwise?",
  "Would you rather have perfect photos at Spaceship Earth or perfect photos by the lagoon?",
  "Would you rather try one new food in every country or one dessert in every country?",
  "Would you rather spend extra time in The Seas or The Land?",
  "Would you rather have a private boat on Gran Fiesta Tour or Living with the Land?",
  "Would you rather design the weirdest Test Track car or the fastest Test Track car?",
  "Would you rather hear Guardians music all day or Figment singing all day?",
  "Would you rather have the best table-service meal or the best festival booth day?",
  "Would you rather rest indoors for an hour or stroll World Showcase slowly for an hour?",
  "Would you rather be a World Showcase tour guide or a Guardians mixtape DJ?",
  "Would you rather have every country stamp your passport or every booth give you a tiny sample?",
  "Would you rather ride Spaceship Earth first or last?",
  "Would you rather spend a rainy hour in The Seas or inside shops around World Showcase?",
  "Would you rather eat breakfast in France or dinner in Mexico?",
  "Would you rather see EPCOT from the Skyliner or from across the lagoon at night?",
  "Would you rather get a surprise low wait for Guardians or Remy?",
  "Would you rather only eat sweet snacks or only eat savory snacks in EPCOT?",
  "Would you rather have a perfect festival plan or a perfect ride plan?",
  "Would you rather be shrunk down with Remy or launched through space with the Guardians?",
  "Would you rather take a family photo in every country or try a snack in every country?",
  "Would you rather spend more time in Japan or Morocco?",
  "Would you rather only use Friendship Boats or only walk the whole day?",
  "Would you rather hear the Voices of Liberty or watch a festival concert?",
  "Would you rather have a quiet bench by the lagoon or a table inside with air conditioning?",
  "Would you rather ride Mission Space Green with everyone or skip it for snacks?",
  "Would you rather have one perfect coffee break or one perfect dessert break?",
  "Would you rather know the best hidden detail in every pavilion or the best snack in every pavilion?",
  "Would you rather spend sunset in France or sunset in Canada?",
  "Would you rather get a surprise character meet or a surprise empty walkway?",
  "Would you rather ride Nemo with no wait or Figment with no wait?",
  "Would you rather have a full day of low waits or perfect weather for World Showcase?",
  "Would you rather be in charge of choosing the next country or the next snack?",
  "Would you rather have a festival passport completed or every headliner completed?",
  "Would you rather watch fireworks close to the exit or close to your favorite country?",
...
const HOLLYWOOD_FAMILY_VOTE_PROMPTS = [
  ...
  {
    prompt: "Which Hollywood Studios land gets the family vote?",
    options: ["Galaxy's Edge", "Toy Story Land", "Sunset Boulevard", "Hollywood Boulevard"],
  },
  {
    prompt: "Which Hollywood ride wins today?",
    options: ["Rise of the Resistance", "Slinky Dog Dash", "Tower of Terror", "Runaway Railway"],
  },
  {
    prompt: "Which family role would be funniest on Smugglers Run?",
    options: ["Pilot", "Gunner", "Engineer", "Person yelling directions"],
  },
  {
    prompt: "Which Toy Story character energy fits the family?",
    options: ["Woody", "Buzz", "Jessie", "Rex"],
  },
  {
    prompt: "Which Star Wars choice wins?",
    options: ["Lightsaber", "Droid", "Blue milk", "Ronto wrap"],
  },
  {
    prompt: "Which Hollywood show gets the vote?",
    options: ["Fantasmic", "Indiana Jones", "Frozen Sing-Along", "Beauty and the Beast"],
  },
  {
    prompt: "Which ride photo would be funniest?",
    options: ["Tower of Terror", "Rock 'n' Roller Coaster", "Slinky Dog", "Runaway Railway"],
  },
  {
    prompt: "Which area should the family slow down in?",
    options: ["Batuu marketplace", "Echo Lake", "Animation Courtyard", "Toy Story Land"],
  },
  {
    prompt: "Which Hollywood snack wins?",
    options: ["Popcorn", "Pretzel", "Ronto Wrap", "Blue milk"],
  },
  {
    prompt: "Which family strategy wins here?",
    options: ["Chase headliners", "Mix in shows", "Snack and reset", "Stay near one area"],
  },
  {
    prompt: "Which Hollywood mood wins?",
    options: ["Big thrills", "Movie magic", "Toy chaos", "Star Wars adventure"],
  },
  {
    prompt: "Which queue would your group handle best?",
    options: ["Immersive Star Wars", "Toy Story outdoor", "Cool indoor theater", "Short and simple"],
  },
  {
    prompt: "Which person should choose the next show?",
    options: ["Biggest movie fan", "Most tired person", "Youngest person", "Whoever has snacks"],
  },
  {
    prompt: "Which Galaxy's Edge moment wins?",
    options: ["Seeing the Falcon", "Walking the marketplace", "Spotting characters", "Nighttime lights"],
  },
  {
    prompt: "Which Toy Story Land moment wins?",
    options: ["Slinky Dog", "Toy Story Mania", "Alien Swirling Saucers", "Green Army fun"],
  },
  {
    prompt: "Which Sunset Boulevard choice wins?",
    options: ["Tower of Terror", "Rock 'n' Roller Coaster", "Beauty and the Beast", "Shady snack"],
  },
  {
    prompt: "Which Hollywood photo wins?",
    options: ["Tower of Terror", "Millennium Falcon", "Toy Story Land", "Chinese Theater"],
  },
  {
    prompt: "Which would make the best family story?",
    options: ["Chaotic Falcon crew", "Tower screams", "Fantasmic finale", "Unexpected character moment"],
  },
  {
    prompt: "Which Hollywood sound wins?",
    options: ["Tower scream", "Star Wars ships", "Slinky coaster", "Fantasmic music"],
  },
  {
    prompt: "Which family member would be best in a stunt show?",
    options: ["Bravest person", "Most dramatic person", "Fastest runner", "Person who denies it"],
  },
  {
    prompt: "Which ride deserves a rematch?",
    options: ["Toy Story Mania", "Smugglers Run", "Slinky Dog", "Runaway Railway"],
  },
  {
    prompt: "Which low-stress Hollywood win matters most?",
    options: ["Good show seat", "Short walk", "Cold drink", "Indoor break"],
  },
  {
    prompt: "Which big-ticket win would feel best?",
    options: ["Rise of the Resistance", "Slinky Dog", "Tower of Terror", "Fantasmic"],
  },
  {
    prompt: "Which family debate would get loudest?",
    options: ["Best ride", "Best snack", "Best land", "Best show"],
  },
  {
    prompt: "Which Star Wars character type fits your group?",
    options: ["Rebel", "Droid", "Smuggler", "First Order trouble"],
  },
  {
    prompt: "Which Toy Story item would your family become?",
    options: ["Slinky", "Crayon", "Green army man", "Alien"],
  },
  {
    prompt: "Which Hollywood ending sounds best?",
    options: ["Fantasmic", "One last ride", "Skyliner exit", "Quiet snack"],
  },
  {
    prompt: "Which line-time game should come next?",
    options: ["Queue Clues", "Would You Rather", "Quick Trivia", "Family Vote again"],
  ...
  {
    prompt: "Which person should be trusted with the next reservation check?",
    options: ["Planner", "Fast phone person", "Most patient person", "Nobody, let TOHI help"],
  },
  {
...
const HOLLYWOOD_WOULD_YOU_RATHER_PROMPTS = [
  ...
  "Would you rather join the Resistance for a daring escape or pilot the Millennium Falcon with your family as the crew?",
  "Would you rather ride Slinky Dog Dash at sunset or Tower of Terror after dark?",
  "Would you rather spend an hour in Toy Story Land or an hour in Galaxy's Edge?",
  "Would you rather get the highest score in Toy Story Mania or be the best pilot on Smugglers Run?",
  "Would you rather watch Fantasmic from great seats or squeeze in two more rides before park close?",
  "Would you rather meet a favorite character or get the funniest family ride photo?",
  "Would you rather eat a Ronto Wrap or try blue milk just to say you did?",
  "Would you rather be in a Star Wars story or a Mickey cartoon story?",
  "Would you rather ride Runaway Railway with no wait or Toy Story Mania with no wait?",
  "Would you rather brave Tower of Terror once or ride Slinky Dog twice?",
  "Would you rather spend extra time exploring Batuu or Sunset Boulevard?",
  "Would you rather be a rebel spy or a toy in Andy's backyard?",
  "Would you rather watch Indiana Jones stunts or sing along with Frozen?",
  "Would you rather have one perfect Hollywood Studios morning or one perfect Hollywood Studios night?",
  "Would you rather ride Rock 'n' Roller Coaster with the music blasting or Tower of Terror with everyone screaming?",
  "Would you rather build a droid or design a toy-sized ride for Andy's backyard?",
  "Would you rather take a break inside a show or keep moving with snacks and short waits?",
  "Would you rather be chased by Kylo Ren or dropped into the Twilight Zone?",
  "Would you rather ride Alien Swirling Saucers with the silliest person in your group or Toy Story Mania with the most competitive person?",
  "Would you rather have a perfect Galaxy's Edge photo or a perfect Tower of Terror photo?",
  "Would you rather start the day in Toy Story Land or Galaxy's Edge?",
  "Would you rather end the night with Fantasmic or a final ride on Slinky Dog?",
  "Would you rather snack like you're on Batuu or eat classic Hollywood park snacks?",
  "Would you rather get stuck in line with Star Wars fans or Toy Story fans?",
  "Would you rather have one huge thrill next or one funny family ride next?",
  "Would you rather ride Mickey and Minnie's Runaway Railway while everyone sings along or while everyone points out hidden details?",
  "Would you rather get a surprise low wait for Rise of the Resistance or a surprise low wait for Slinky Dog Dash?",
  "Would you rather be the family navigator in Galaxy's Edge or the scorekeeper in Toy Story Mania?",
  "Would you rather watch a stage show from great seats or stumble into a character moment with no wait?",
  "Would you rather take the Skyliner away from Hollywood Studios or walk out after Fantasmic with the crowd energy?",
  "Would you rather spend your break in Animation Courtyard or near Echo Lake?",
  "Would you rather ride Star Tours and get a wild scene combo or ride Smugglers Run with a chaotic family crew?",
  "Would you rather be the person who chooses the next show or the person who chooses the next snack?",
  "Would you rather do all the Toy Story rides in a row or all the Star Wars rides in a row?",
  "Would you rather have a relaxing Hollywood Studios day with shows or a packed day chasing headliners?",
  "Would you rather walk through Batuu at rope drop or after dark when everything glows?",
  "Would you rather be a Muppet for a day or a Green Army toy for a day?",
  "Would you rather get a perfect spot for Fantasmic or a perfect last-minute ride window?",
  "Would you rather have everyone agree on the next ride or have a family vote that ends in a tie?",
  "Would you rather ride Tower of Terror with the bravest person or Toy Story Mania with the loudest trash talker?",
  "Would you rather spend money on a Star Wars souvenir or a snack everyone shares?",
  "Would you rather be in charge of avoiding long waits or finding the funniest things to do?",
  "Would you rather take a slow lap through Hollywood Boulevard or rush straight to the next must-do?",
  "Would you rather have a front-row show seat or a front-row coaster seat?",
  "Would you rather find a hidden detail in Galaxy's Edge or a classic Hollywood photo spot?",
  "Would you rather ride Rise once with a long wait or skip it and have a calmer day?",
  "Would you rather get blue milk mustaches in a photo or a dramatic Tower of Terror pose?",
  "Would you rather spend your last hour in Toy Story Land or Galaxy's Edge?",
  "Would you rather let the Star Wars fan pick the next move or the Toy Story fan pick the next move?",
  "Would you rather finish the day with one big scream or one big laugh?",
  "Would you rather pilot the Millennium Falcon perfectly or crash it in the funniest way possible?",
  "Would you rather ride Rise of the Resistance with no wait or Slinky Dog Dash with no wait?",
  "Would you rather be trapped in Tower of Terror or chased through space on Rock 'n' Roller Coaster?",
  "Would you rather spend the day in Galaxy's Edge or Toy Story Land?",
  "Would you rather have blue milk or a Ronto Wrap as your only snack?",
  "Would you rather be a rebel spy or a First Order recruit?",
  "Would you rather get a perfect Tower of Terror photo or a perfect Slinky Dog photo?",
  "Would you rather watch Fantasmic from the front or sit farther back with an easy exit?",
  "Would you rather be a Toy Story Mania champion or a Smugglers Run pilot?",
  "Would you rather ride Runaway Railway with Mickey or Slinky Dog with Woody?",
  "Would you rather spend an hour in Batuu at night or Toy Story Land at night?",
  "Would you rather build a droid or build a lightsaber?",
  "Would you rather have Chewbacca help you on a mission or Buzz Lightyear help you in Toy Story Land?",
  "Would you rather only do shows or only do rides for the next two hours?",
  "Would you rather get stuck in the Tower of Terror lobby or the Rise of the Resistance hangar?",
  "Would you rather hear Star Wars sounds all day or old Hollywood music all day?",
  "Would you rather take a family photo by the Falcon or by Tower of Terror?",
  "Would you rather ride Alien Swirling Saucers ten times or Toy Story Mania three times?",
  "Would you rather have the perfect lunch in Batuu or the perfect snack on Sunset Boulevard?",
  "Would you rather be in a Frozen sing-along or an Indiana Jones stunt show?",
  "Would you rather have a private ride on Runaway Railway or Toy Story Mania?",
  "Would you rather get picked for a show moment or get a surprise character wave?",
  "Would you rather be a Jedi for a day or a toy in Andy's backyard?",
  "Would you rather walk through Galaxy's Edge with no crowds or Toy Story Land with no crowds?",
  "Would you rather rope drop Rise or close the night with Fantasmic?",
  "Would you rather sit in air conditioning for a show or keep moving for one more ride?",
  "Would you rather get a surprise low wait for Tower of Terror or Slinky Dog Dash?",
  "Would you rather eat only Star Wars snacks or only classic theme park snacks?",
  "Would you rather have a perfect Hollywood Studios ride day or a perfect show day?",
  "Would you rather be the loudest person on Tower of Terror or the calmest person on Tower of Terror?",
  "Would you rather score best in your family on Toy Story Mania or Buzz Lightyear at Magic Kingdom?",
  "Would you rather ride Star Tours with the wildest sequence or Smugglers Run with the best crew?",
  "Would you rather spend a rainy hour in shops or in shows?",
  "Would you rather have a stroller-friendly perfect route or a thrill-heavy perfect route?",
  "Would you rather hear the Tower of Terror scream all day or Slinky Dog music all day?",
  "Would you rather be the person who knows every movie quote or every ride shortcut?",
  "Would you rather meet a Star Wars character or a Toy Story character?",
  "Would you rather watch Beauty and the Beast or Frozen Sing-Along?",
  "Would you rather have a perfect photo in front of the Chinese Theater or inside Galaxy's Edge?",
  "Would you rather only ride headliners or only do low-wait attractions for the next hour?",
  "Would you rather have a perfect mobile order or a perfect showtime plan?",
  "Would you rather be a stormtrooper for a day or a green army man for a day?",
  "Would you rather ride Rock 'n' Roller Coaster in the front or Tower of Terror in the back?",
  "Would you rather take the Skyliner out or walk slowly through Hollywood Boulevard at night?",
  "Would you rather get the best seat at Fantasmic or the shortest wait of the day right after it?",
  "Would you rather have one giant Hollywood Studios win or three small easy wins?",
  "Would you rather have Toy Story Land all to yourself or Galaxy's Edge all to yourself?",
  "Would you rather end with one last thrill ride or one last show?",
  "Would you rather find the funniest ride photo or the coolest hidden detail?",
  "Would you rather be in charge of the next ride or the next snack?",
];
...
const ANIMAL_KINGDOM_FAMILY_VOTE_PROMPTS = [
  ...
  {
    prompt: "Which Animal Kingdom area gets the family vote?",
    options: ["Pandora", "Africa", "Asia", "Discovery Island"],
  },
  {
    prompt: "Which Animal Kingdom ride wins today?",
    options: ["Flight of Passage", "Everest", "Kilimanjaro Safaris", "Na'vi River Journey"],
  },
  {
    prompt: "Which animal would the family most want to spot?",
    options: ["Giraffe", "Elephant", "Tiger", "Gorilla"],
  },
  {
    prompt: "Which Animal Kingdom pace fits right now?",
    options: ["Slow trails", "Big ride", "Show break", "Snack and shade"],
  },
  {
    prompt: "Which show gets the vote?",
    options: ["Festival of the Lion King", "Finding Nemo", "Feathered Friends", "Any indoor show"],
  },
  {
    prompt: "Which trail sounds best?",
    options: ["Gorilla Falls", "Maharajah Jungle Trek", "Discovery Island trails", "Whichever has shade"],
  },
  {
    prompt: "Which Pandora moment wins?",
    options: ["Flight of Passage", "Na'vi River Journey", "Nighttime glow", "Snack stop"],
  },
  {
    prompt: "Which Everest choice wins?",
    options: ["Front row", "Back row", "Watch from below", "Skip and snack"],
  },
  {
    prompt: "Which safari role fits the family?",
    options: ["Animal spotter", "Photo taker", "Fact collector", "Person yelling giraffe"],
  },
  {
    prompt: "Which Animal Kingdom snack wins?",
    options: ["Night Blossom", "Pretzel", "Popcorn", "Ice cream"],
  },
  {
    prompt: "Which family strategy wins?",
    options: ["Animals first", "Rides first", "Shows during heat", "Follow the shade"],
  },
  {
    prompt: "Which Tree of Life detail should win?",
    options: ["Animal carvings", "Roots", "Night lighting", "Family photo spot"],
  },
  {
    prompt: "Which animal sound would be coolest to hear?",
    options: ["Lion", "Birds", "Drums nearby", "Waterfall"],
  },
  {
    prompt: "Which family member would be the best safari guide?",
    options: ["Animal lover", "Best storyteller", "Best eyesight", "Most excited person"],
  },
  {
    prompt: "Which wet-or-dry choice wins?",
    options: ["Kali River Rapids", "Stay dry", "Misting fan", "Indoor show"],
  },
  {
    prompt: "Which Animal Kingdom view wins?",
    options: ["Tree of Life", "Everest", "Pandora mountains", "Safari savanna"],
  },
  {
    prompt: "Which low-stress win matters most?",
    options: ["Shade", "Cold drink", "Quiet path", "Short wait"],
  },
  {
    prompt: "Which animal trail goal wins?",
    options: ["See something new", "Take photos", "Read the signs", "Just enjoy the shade"],
  },
  {
    prompt: "Which family debate would be funniest?",
    options: ["Best animal", "Best ride", "Best snack", "Best show"],
  },
  {
    prompt: "Which Animal Kingdom smell wins?",
    options: ["Rainforest", "Popcorn", "Barbecue", "Fresh rain"],
  },
  {
    prompt: "Which Discovery Island choice wins?",
    options: ["Tree of Life photo", "Trails", "Snack stop", "Quiet bench"],
  },
  {
    prompt: "Which Africa choice wins?",
    options: ["Safari", "Harambe snacks", "Festival of the Lion King", "Train ride"],
  },
  {
    prompt: "Which Asia choice wins?",
    options: ["Everest", "Kali", "Tiger trail", "Shaded path"],
  },
  {
    prompt: "Which Dinoland-style choice wins?",
    options: ["Dinosaur", "Fossil fun", "Silly photo", "Move on quickly"],
  },
  {
    prompt: "Which person should pick the next animal to look for?",
    options: ["Youngest person", "Animal expert", "Best guesser", "Whoever is least tired"],
  },
  {
    prompt: "Which would make the best story later?",
    options: ["Animal surprise", "Ride scream", "Getting soaked", "Perfect calm break"],
  },
  {
    prompt: "Which Animal Kingdom ending sounds best?",
    options: ["Pandora glow", "Safari memory", "Tree of Life photo", "One last ride"],
  },
  {
    prompt: "Which line-time game should come next?",
    options: ["Queue Clues", "Would You Rather", "Quick Trivia", "Family Vote again"],
  ...
  {
    prompt: "Which family badge would your group earn?",
    options: ["Best animal spotters", "Best snack sharers", "Best shade finders", "Best ride bravery"],
  },
  {
...
const ANIMAL_KINGDOM_WOULD_YOU_RATHER_PROMPTS = [
  ...
  "Would you rather ride Expedition Everest with the bravest person in your group or Kilimanjaro Safaris with the best animal spotter?",
  "Would you rather spend an hour in Pandora or an hour on the animal trails?",
  "Would you rather see a giraffe walk close to the safari truck or hear a lion roar from far away?",
  "Would you rather ride Flight of Passage once or Na'vi River Journey twice with no wait?",
  "Would you rather cool off on Kali River Rapids or stay dry and watch Festival of the Lion King?",
  "Would you rather find the best animal carving on the Tree of Life or the best hidden trail view?",
  "Would you rather eat a fun Pandora snack or a classic Animal Kingdom treat?",
  "Would you rather explore Animal Kingdom early in the morning or in the evening when the paths calm down?",
  "Would you rather be a Wilderness Explorer or a safari guide for a day?",
  "Would you rather ride Dinosaur with everyone yelling or Everest with everyone laughing after?",
  "Would you rather watch the macaws fly overhead or spend extra time watching gorillas?",
  "Would you rather take a quiet shady break or push to one more animal trail?",
  "Would you rather see tigers active on the Maharajah Jungle Trek or gorillas active on the Gorilla Falls trail?",
  "Would you rather spend extra time in Africa or Asia?",
  "Would you rather take a family photo in front of the Tree of Life or in Pandora at night?",
  "Would you rather get soaked on Kali River Rapids or sweat through a long sunny walk?",
  "Would you rather ride the safari when animals are active or when the wait is shortest?",
  "Would you rather have a calm day with shows and trails or a thrill day with Everest, Dinosaur, and Pandora?",
  "Would you rather find a perfect shaded bench or a perfect animal viewing spot?",
  "Would you rather be tiny under the Tree of Life or fly on a banshee over Pandora?",
  "Would you rather try a new Animal Kingdom snack or repeat the snack everyone already loves?",
  "Would you rather take the train to Rafiki's Planet Watch or spend that time on another trail?",
  "Would you rather hear the drums in Harambe or the sounds of Pandora at night?",
  "Would you rather spot an animal nobody else saw or answer a Wilderness Explorer question first?",
  "Would you rather ride Everest front row or back row?",
  "Would you rather walk a quiet trail in the rain or take shelter and wait it out?",
  "Would you rather spend a whole hour looking for animals or a whole hour doing rides?",
  "Would you rather be the family photographer or the family animal spotter?",
  "Would you rather have a perfect safari ride or a perfect Pandora evening?",
  "Would you rather leave Animal Kingdom early for a pool break or stay until the park feels calmer?",
  "Would you rather ride Na'vi River Journey to relax or watch Finding Nemo to rest your feet?",
  "Would you rather have a surprise low wait for Everest or a surprise low wait for Flight of Passage?",
  "Would you rather spend more time watching elephants or more time watching tigers?",
  "Would you rather get a little wet for a shorter wait or stay dry with a longer wait?",
  "Would you rather choose the next ride based on shade or based on excitement?",
  "Would you rather have a peaceful lunch break or a quick snack and keep moving?",
  "Would you rather walk through Pandora in bright daylight or glowing nighttime colors?",
  "Would you rather be a scientist in Dinosaur or an explorer on Everest?",
  "Would you rather spot a baby animal or see a big animal up close?",
  "Would you rather have one unforgettable animal moment or three solid ride wins?",
  "Would you rather let the animal lover choose next or let the thrill seeker choose next?",
  "Would you rather spend the hottest part of the day in shows or in shaded trails?",
  "Would you rather have the whole family earn Wilderness Explorer badges or have everyone pick one favorite animal?",
  "Would you rather ride the safari twice and see different animals or ride Everest twice and compare screams?",
  "Would you rather hear a Cast Member animal fact or find a hidden detail yourself?",
  "Would you rather get a family photo with the Tree of Life or with Everest in the background?",
  "Would you rather spend your final Animal Kingdom hour in Pandora or on a peaceful trail?",
  "Would you rather take a slow walk through Discovery Island or rush to one last ride?",
  "Would you rather choose a show because it is great or because everyone needs air conditioning?",
  "Would you rather finish Animal Kingdom with a big adventure or a calm animal moment?",
  "Would you rather ride Flight of Passage twice or Kilimanjaro Safaris twice?",
  "Would you rather see a giraffe up close or hear a lion roar?",
  "Would you rather walk every animal trail or ride every big ride?",
  "Would you rather spend the whole day in Pandora or the whole day between Africa and Asia?",
  "Would you rather ride Everest in the front or in the back?",
  "Would you rather get soaked on Kali River Rapids or stay dry but skip it?",
  "Would you rather watch Festival of the Lion King or Finding Nemo?",
  "Would you rather find the coolest animal carving or spot the rarest animal?",
  "Would you rather have perfect weather or perfect low waits at Animal Kingdom?",
  "Would you rather eat at Satu'li Canteen or grab snacks around Harambe?",
  "Would you rather see Pandora glowing at night or the Tree of Life glowing at night?",
  "Would you rather be a safari guide or a Wilderness Explorer leader?",
  "Would you rather ride Dinosaur with the lights on or Everest with no Yeti mystery?",
  "Would you rather have a peaceful animal trail or a thrilling coaster ride?",
  "Would you rather meet Kevin or see a real tiger active on the trail?",
  "Would you rather get a surprise low wait for Flight of Passage or Everest?",
  "Would you rather take a family photo by the Tree of Life or in Pandora?",
  "Would you rather be a banshee rider or a safari driver?",
  "Would you rather spend a rainy hour under covered paths or inside shows?",
  "Would you rather have the best snack break or the best shade break?",
  "Would you rather only do animal experiences or only do rides for the next two hours?",
  "Would you rather hear drums in Harambe or waterfall sounds in Pandora all day?",
  "Would you rather see elephants on safari or gorillas on the trail?",
  "Would you rather have a private safari truck or a private Na'vi River Journey boat?",
  "Would you rather walk slowly through Maharajah Jungle Trek or Gorilla Falls?",
  "Would you rather have every animal active or every ride under twenty minutes?",
  "Would you rather eat a Night Blossom snack or a giant Mickey pretzel?",
  "Would you rather sit in the shade for thirty minutes or ride one more attraction?",
  "Would you rather be brave on Everest or calm on Na'vi River Journey?",
  "Would you rather explore Discovery Island trails or the Boneyard?",
  "Would you rather spot birds everywhere or hidden Mickeys everywhere?",
  "Would you rather get the best safari photo or the best Everest photo?",
  "Would you rather rope drop Pandora or end the day in Pandora?",
  "Would you rather be in charge of spotting animals or finding shade?",
  "Would you rather learn one amazing animal fact or find one amazing quiet path?",
  "Would you rather watch macaws fly overhead or see a baby animal on safari?",
  "Would you rather cool off in a show or with a cold drink?",
  "Would you rather ride Kali twice and get soaked or Everest once and stay dry?",
  "Would you rather only walk shaded paths or take the fastest route every time?",
  "Would you rather spend extra time in Africa or extra time in Asia?",
  "Would you rather have an animal keeper answer your questions or a ride designer answer your questions?",
  "Would you rather end with Tree of Life photos or Pandora at night?",
  "Would you rather have one perfect safari or one perfect Flight of Passage ride?",
  "Would you rather take the train to Rafiki's Planet Watch or stay near the main paths?",
  "Would you rather find the best quiet bench or the best snack window?",
  "Would you rather hear the Everest train all day or safari truck radio all day?",
  "Would you rather see every animal your family hoped for or finish every must-do ride?",
  "Would you rather have a slow peaceful morning or a big exciting afternoon?",
  "Would you rather be the family animal expert or the family route expert?",
  "Would you rather finish Animal Kingdom with one last trail or one last ride?",
];
...
const QUEUE_CLUES_BY_PARK = {
  magic_kingdom: [
    ...
    ["Monorail", "Turnstile", "Tunnel", "Popcorn", "Balloon"],
    ["Main Street", "Trolley", "Emporium", "Window", "Piano"],
    ["Castle", "Moat", "Stage", "Spire", "Wish"],
    ["Pirate", "Cannon", "Treasure", "Parrot", "Ship"],
    ["Haunted", "Ghost", "Mansion", "Candle", "Graveyard"],
    ["Thunder", "Mine", "Train", "Dynamite", "Mountain"],
    ["Jungle", "Skipper", "Hippo", "Temple", "Boat"],
    ["Bayou", "Frog", "Log", "Lantern", "Splash"],
    ["Space", "Rocket", "Star", "Tunnel", "Launch"],
    ["Carousel", "Horse", "Sword", "Crown", "Fantasy"],
    ["Mermaid", "Shell", "Grotto", "Seaweed", "Prince"],
    ["Peter Pan", "Pixie", "London", "Shadow", "Neverland"],
    ["Dumbo", "Circus", "Feather", "Tent", "Elephant"],
    ["Pooh", "Honey", "Heffalump", "Tigger", "Tree"],
    ["Small World", "Doll", "Clock", "Goodbye", "Boat"],
    ["Liberty", "Riverboat", "Bell", "Paddle", "Colonial"],
    ["Hall", "President", "Speech", "Flag", "Portrait"],
    ["Country Bear", "Guitar", "Stage", "Curtain", "Banjo"],
    ["Tiki", "Bird", "Flower", "Volcano", "Song"],
    ["PeopleMover", "Tomorrowland", "Track", "Breeze", "Robot"],
    ["Buzz", "Laser", "Zurg", "Space Ranger", "Target"],
    ["TRON", "Grid", "Lightcycle", "Blue", "Portal"],
    ["Castle Hub", "Statue", "Partners", "Bridge", "Fireworks"],
    ["Parade", "Float", "Drum", "Confetti", "Wave"],
    ["Fireworks", "Boom", "Color", "Sky", "Music"],
    ["Churro", "Pretzel", "Turkey Leg", "Dole Whip", "Snack"],
    ["Stroller", "Fan", "Poncho", "Map", "Backpack"],
    ["MagicBand", "Tap", "Lightning", "PhotoPass", "Reservation"],
    ["Adventureland", "Torch", "Bridge", "Drum", "Oasis"],
    ["Fantasyland", "Storybook", "Castle Wall", "Cottage", "Dragon"],
    ["Castle", "Walt", "Mickey", "Hub", "Statue"],
    ["Main Street", "Bakery", "Balloon", "Horse", "Window"],
    ["Firehouse", "Flagpole", "Train", "Station", "Tunnel"],
    ["Adventure", "Map", "Torch", "Skipper", "River"],
    ["Pirates", "Jail", "Dog", "Key", "Treasure"],
    ["Jungle Cruise", "Elephant", "Drum", "Waterfall", "Temple"],
    ["Tiki Room", "Bird", "Chorus", "Lantern", "Totem"],
    ["Dole Whip", "Pineapple", "Cup", "Float", "Spoon"],
    ["Frontierland", "Rifle", "Boardwalk", "River", "Mountain"],
    ["Big Thunder", "Goat", "Dynamite", "Cave", "Train"],
    ["Tiana", "Bayou", "Music", "Critter", "Drop"],
    ["Tom Sawyer", "Island", "Fort", "Bridge", "Cave"],
    ["Liberty Square", "Lantern", "Bell", "Riverboat", "Brick"],
    ["Haunted Mansion", "Portrait", "Doom Buggy", "Attic", "Bride"],
    ["Fantasyland", "Turret", "Storybook", "Teacup", "Castle"],
    ["Teacups", "Spin", "Cup", "Saucer", "Lantern"],
    ["Mine Train", "Gem", "Dwarf", "Lantern", "Cottage"],
    ["PhilharMagic", "Donald", "Orchestra", "Screen", "Magic"],
    ["Tomorrowland", "Rocket", "Neon", "Transit", "Launch"],
    ["Space Mountain", "Stars", "Darkness", "Rocket", "Drop"],
    ["TRON", "Team Blue", "Digitizer", "Grid", "Cycle"],
    ["Monsters", "Laugh", "Microphone", "Screen", "Joke"],
    ["Carousel", "Royal", "Horse", "Music", "Mirror"],
    ["Enchanted Tales", "Wardrobe", "Rose", "Library", "Belle"],
    ["Princess", "Crown", "Gown", "Castle", "Royal"],
    ["Fireworks", "Castle", "Music", "Crowd", "Sky"],
    ["Parade", "Rope", "Float", "Character", "Wave"],
    ["Mobile Order", "Pickup", "Snack", "Window", "Receipt"],
    ["Lightning Lane", "Tap", "Clock", "Return", "Scan"],
    ["Family", "Stroller", "Fan", "Water", "Shade"],
  ],
  epcot: [
    ...
    ["Spaceship Earth", "Geosphere", "Triangle", "Time", "Stars"],
    ["World Showcase", "Lagoon", "Passport", "Pavilion", "Bridge"],
    ["Monorail", "Track", "Loop", "Station", "View"],
    ["Figment", "Imagination", "Dragon", "Rainbow", "Spark"],
    ["Soarin", "Glider", "Orange", "Hangar", "Cloud"],
    ["Living Seas", "Aquarium", "Turtle", "Coral", "Bubble"],
    ["Nemo", "Clam", "Anemone", "Jellyfish", "Current"],
    ["Land", "Greenhouse", "Boat", "Cucumber", "Harvest"],
    ["Test Track", "Design", "Speed", "Curve", "Car"],
    ["Mission Space", "Mars", "Capsule", "Launch", "Commander"],
    ["Guardians", "Mixtape", "Galaxy", "Dance", "Nova"],
    ["Remy", "Rat", "Kitchen", "Cheese", "Paris"],
    ["Frozen", "Snowflake", "Arendelle", "Boat", "Elsa"],
    ["Mexico", "Pyramid", "Coco", "Mariachi", "River"],
    ["Norway", "Troll", "Viking", "Fjord", "Bakery"],
    ["China", "Temple", "Lantern", "Dragon", "Garden"],
    ["Germany", "Clock", "Pretzel", "Train", "Village"],
    ["Italy", "Gondola", "Fountain", "Mask", "Gelato"],
    ["America", "Flag", "Voices", "Rotunda", "Drum"],
    ["Japan", "Pagoda", "Koi", "Torii", "Marketplace"],
    ["Morocco", "Tile", "Arch", "Fountain", "Lantern"],
    ["France", "Eiffel", "Bakery", "Perfume", "Bridge"],
    ["United Kingdom", "Tea", "Rose", "Phone Booth", "Pub"],
    ["Canada", "Waterfall", "Totem", "Garden", "Maple"],
    ["Festival", "Booth", "Passport", "Sampler", "Concert"],
    ["Skyliner", "Gondola", "Cable", "Station", "Breeze"],
    ["Fireworks", "Lagoon", "Globe", "Reflection", "Finale"],
    ["Crepe", "Popcorn", "Pretzel", "School Bread", "Snack"],
    ["Kidcot", "Sticker", "Card", "Marker", "Traveler"],
    ["Future World", "Fountain", "Plaza", "Spaceship", "Path"],
    ["Spaceship Earth", "Phoenician", "Printing", "Computer", "Stars"],
    ["Dreamers Point", "Walt", "Bench", "Garden", "Fountain"],
    ["Connections", "Coffee", "Table", "Charger", "Break"],
    ["Creations", "Shop", "Figment", "Mickey", "Souvenir"],
    ["Imagination", "Lab", "Scent", "Sound", "Figment"],
    ["The Land", "Escalator", "Balloon", "Sunshine", "Garden"],
    ["Living with the Land", "Pumpkin", "Fish", "Greenhouse", "Boat"],
    ["Soarin", "Concourses", "Seatbelt", "Screen", "Breeze"],
    ["The Seas", "Seagull", "Aquarium", "Manatee", "Window"],
    ["Turtle Talk", "Crush", "Shell", "Hydrophone", "Kids"],
    ["Test Track", "SimCar", "Design", "Scan", "Track"],
    ["Mission Space", "Orange", "Green", "Capsule", "Mars"],
    ["Guardians", "Xandar", "Starblaster", "Teleport", "Mixtape"],
    ["Mexico", "Volcano", "Market", "Boat", "Donald"],
    ["Gran Fiesta", "Caballero", "River", "Fireworks", "Pyramid"],
    ["Norway", "Royal", "Bakery", "Ship", "Snowman"],
    ["China", "Reflections", "Lotus", "Gate", "Acrobat"],
    ["Germany", "Caramel", "Clock", "Village", "Mini Train"],
    ["Italy", "Tower", "Piazza", "Fountain", "Pizza"],
    ["America", "Rotunda", "Voices", "Fife", "Drum"],
    ["Japan", "Mitsukoshi", "Candy", "Garden", "Pagoda"],
    ["Morocco", "Mosaic", "Courtyard", "Lamp", "Archway"],
    ["France", "Remy", "Gusteau", "Bakery", "Fountain"],
    ["United Kingdom", "Garden", "Tea", "Maze", "Bandstand"],
    ["Canada", "Rockwork", "Waterfall", "Film", "Maple"],
    ["Festival Booth", "Menu", "Stamp", "Fork", "Plate"],
    ["Friendship Boat", "Dock", "Lagoon", "Flag", "Captain"],
    ["Skyliner", "Bucket", "Cable", "Turn", "Resort"],
    ["Fireworks", "Barge", "Lagoon", "Reflection", "Finale"],
    ["World Showcase", "Clockwise", "Country", "Snack", "Passport"],
  ],
  hollywood: [
    ...
    ["Hollywood", "Boulevard", "Palm", "Neon", "Camera"],
    ["Chinese Theater", "Footprint", "Marquee", "Movie", "Curtain"],
    ["Runaway Railway", "Picnic", "Train", "Whistle", "Cartoon"],
    ["Tower", "Elevator", "Lightning", "Hotel", "Bellhop"],
    ["Slinky", "Dog", "Coaster", "Spring", "Toy"],
    ["Toy Story", "Andy", "Block", "Crayon", "Backyard"],
    ["Midway Mania", "Glasses", "Ring", "Target", "Booth"],
    ["Alien Swirling", "Claw", "Saucer", "Planet", "Spin"],
    ["Star Wars", "Droid", "Saber", "Cantina", "Datapad"],
    ["Falcon", "Cockpit", "Hyperdrive", "Smuggler", "Cargo"],
    ["Rise", "Resistance", "First Order", "Transport", "Stormtrooper"],
    ["Batuu", "Market", "Spire", "Creature", "Outpost"],
    ["Muppet", "Penguin", "Theater", "Balcony", "Chaos"],
    ["Indiana", "Stunt", "Boulder", "Whip", "Temple"],
    ["Frozen Sing Along", "Royal", "Storyteller", "Snow", "Song"],
    ["Beauty", "Beast", "Rose", "Castle", "Stage"],
    ["Fantasmic", "Dragon", "Water", "Sorcerer", "Dream"],
    ["Rock", "Limo", "Guitar", "Backstage", "Launch"],
    ["Lightning McQueen", "Race", "Pit", "Champion", "Engine"],
    ["Animation", "Sketch", "Pencil", "Character", "Studio"],
    ["Red Carpet", "Spotlight", "Premiere", "Poster", "Star"],
    ["Popcorn", "Pretzel", "Blue Milk", "Ronto", "Snack"],
    ["Skyliner", "Gondola", "Station", "Cable", "Resort"],
    ["Echo Lake", "Dinosaur", "Boat", "Dock", "Sign"],
    ["Sunset", "Theater", "Billboard", "Palm", "Twilight"],
    ["Hollywood Tower", "Lobby", "Dust", "Key", "Service"],
    ["Green Army", "Drum", "March", "Toy", "Salute"],
    ["Woody", "Jessie", "Buzz", "Rex", "Slinky"],
    ["Rey", "Chewie", "BB8", "Kylo", "Resistance"],
    ["Showtime", "Queue", "Curtain", "Applause", "Finale"],
    ["Hollywood Boulevard", "Marquee", "Trolley", "Palm", "Spotlight"],
    ["Chinese Theater", "Handprint", "Forecourt", "Poster", "Premiere"],
    ["Runaway Railway", "Chuuby", "Daisy", "Factory", "Train"],
    ["Mickey", "Minnie", "Picnic", "Conductor", "Whistle"],
    ["Sunset Boulevard", "Billboard", "Theater", "Tower", "Palm"],
    ["Tower of Terror", "Library", "Elevator", "Lightning", "Drop"],
    ["Rock Coaster", "Aerosmith", "Limo", "Launch", "Guitar"],
    ["Beauty Show", "Rose", "Gaston", "Beast", "Curtain"],
    ["Toy Story Land", "Blocks", "Christmas Lights", "Fence", "Backyard"],
    ["Slinky Dog", "Dash", "Launch", "Hills", "Tail"],
    ["Toy Story Mania", "Cannon", "Plate", "Ring", "Score"],
    ["Alien Saucers", "Claw", "Rocket", "Music", "Spin"],
    ["Woody", "Hat", "Boot", "Sheriff", "Lasso"],
    ["Buzz", "Wings", "Laser", "Space", "Star Command"],
    ["Galaxy's Edge", "Spire", "Datapad", "Marketplace", "Creature"],
    ["Millennium Falcon", "Chess", "Hallway", "Cockpit", "Engineer"],
    ["Smugglers Run", "Hondo", "Coaxium", "Pilot", "Damage"],
    ["Rise", "BB8", "Rey", "Transport", "Interrogation"],
    ["First Order", "Hangar", "Trooper", "Kylo", "Escape"],
    ["Droid Depot", "Parts", "Belt", "Astromech", "Remote"],
    ["Savi", "Crystal", "Hilt", "Saber", "Gatherer"],
    ["Oga", "Cantina", "DJ", "Fizz", "Booth"],
    ["Ronto", "Roaster", "Wrap", "Droid", "Grill"],
    ["Muppets", "Kermit", "Piggy", "Balcony", "Penguin"],
    ["Star Tours", "Starspeeder", "C3PO", "Glasses", "Planet"],
    ["Indiana Jones", "Rope", "Boulder", "Plane", "Explosion"],
    ["Frozen Show", "Arendelle", "Historian", "Elsa", "Snow"],
    ["Fantasmic", "Sorcerer", "Mist", "Villain", "Mountain"],
    ["Animation Courtyard", "Sketch", "Gallery", "Meet", "Studio"],
    ["Echo Lake", "Dinosaur", "Boat", "Gertie", "Dock"],
  ],
  animal_kingdom: [
    ...
    ["Tree of Life", "Carving", "Roots", "Animal", "Trunk"],
    ["Safari", "Savanna", "Giraffe", "Rhino", "Truck"],
    ["Everest", "Yeti", "Mountain", "Tea", "Track"],
    ["Pandora", "Banshee", "Floating", "Bioluminescent", "Valley"],
    ["Flight", "Avatar", "Link", "Soar", "Ikran"],
    ["River Journey", "Shaman", "Cave", "Glow", "Boat"],
    ["Dinosaur", "Meteor", "Countdown", "Rover", "Fossil"],
    ["Kali", "Rapids", "Raft", "Splash", "Temple"],
    ["Lion King", "Tumble", "Circle", "Timon", "Festival"],
    ["Finding Nemo", "Puppet", "Current", "Reef", "Song"],
    ["Gorilla", "Trail", "Forest", "Observation", "Silverback"],
    ["Tiger", "Maharajah", "Ruin", "Lantern", "Pool"],
    ["Africa", "Harambe", "Market", "Drum", "Train"],
    ["Asia", "Prayer Flag", "Temple", "Bridge", "Expedition"],
    ["Dinoland", "Carnival", "Fossil", "Game", "Dino"],
    ["Oasis", "Waterfall", "Path", "Shade", "Discovery"],
    ["Wilderness", "Badge", "Explorer", "Sticker", "Guide"],
    ["Conservation", "Station", "Animal Care", "Train", "Habitat"],
    ["Flamingo", "Ostrich", "Elephant", "Okapi", "Zebra"],
    ["Macaw", "Wing", "Flight", "Color", "Perch"],
    ["Drum", "Dance", "Market", "Mask", "Celebration"],
    ["Night Blossom", "Pongu", "Pretzel", "Dole Whip", "Snack"],
    ["Rainforest", "Vine", "Moss", "Mist", "Canopy"],
    ["Creature", "Habitat", "Tracks", "Feather", "Paw"],
    ["Bridge", "River", "Trail", "Lookout", "Map"],
    ["Rafiki", "Planet", "Watch", "Vet", "Drawing"],
    ["Yeti Museum", "Lantern", "Footprint", "Camp", "Expedition"],
    ["Avatar Drums", "Totem", "Glow", "Plant", "Valley"],
    ["Safari Lodge", "Binoculars", "Mud", "Acacia", "Ranger"],
    ["Animal Care", "Keeper", "Habitat", "Enrichment", "Feeding"],
    ["Oasis", "Stream", "Rock", "Animal", "Trail"],
    ["Discovery Island", "Bridge", "Roots", "Carving", "Path"],
    ["Tree of Life", "Owl", "Turtle", "Branch", "Trunk"],
    ["It's Tough", "Bug", "Glasses", "Acorn", "Theater"],
    ["Africa", "Harambe", "Posters", "Market", "Drums"],
    ["Safari", "Baobab", "Truck", "Warden", "Savanna"],
    ["Kilimanjaro", "Cattle", "Flamingo", "Crocodile", "Bridge"],
    ["Gorilla Falls", "Aviary", "Meerkat", "Hippo", "Viewing"],
    ["Harambe Train", "Station", "Conservation", "Track", "Rafiki"],
    ["Rafiki", "Planet Watch", "Animation", "Vet", "Habitat"],
    ["Festival", "Lion", "Acrobat", "Tumble", "Singer"],
    ["Asia", "Yak", "Prayer", "Flag", "Expedition"],
    ["Everest", "Forbidden", "Temple", "Switchback", "Yeti"],
    ["Kali", "Raft", "Rapids", "Drop", "Soaked"],
    ["Maharajah", "Tiger", "Palace", "Bird", "Mural"],
    ["Anandapur", "Bridge", "River", "Shrine", "Lantern"],
    ["DinoLand", "Fossil", "Chester", "Hester", "Sign"],
    ["Dinosaur", "Time", "Rover", "Carnotaurus", "Meteor"],
    ["Boneyard", "Dig", "Bridge", "Slide", "Fossil"],
    ["Pandora", "Vine", "Floating", "Mountain", "Glow"],
    ["Flight of Passage", "Link", "Banshee", "Breathing", "Soar"],
    ["Na'vi River", "Totem", "Shaman", "Cave", "Song"],
    ["Satu'li", "Bowl", "Pods", "Sauce", "Tray"],
    ["Pongu", "Night Blossom", "Pearls", "Cup", "Glow"],
    ["Wilderness Explorer", "Badge", "Handbook", "Station", "Promise"],
    ["Animal Trail", "Footprint", "Keeper", "Sign", "Binoculars"],
    ["Rainstorm", "Poncho", "Canopy", "Mist", "Puddle"],
    ["Shade", "Fan", "Water", "Bench", "Rest"],
    ["Winged", "Macaw", "Color", "Perch", "Flight"],
    ["Conservation", "Care", "Nutrition", "Enrichment", "Keeper"],
  ],
};
